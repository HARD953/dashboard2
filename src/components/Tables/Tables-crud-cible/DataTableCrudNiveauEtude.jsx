...
const DataTableCrudNiveauEtude = (props) => {
...
//Réception des données
    ...
    useEffect(() => {
        ...
        productService.getNiveauEtude().then(data =>  setProducts(data));
        ...
        return (
            <React.Fragment>
                <div  className="d-flex" style={{justifyContent:"space-between"}} >
                    ...
                    <span className='h3'>Liste Niveau Etude</span>
...
export default DataTableCrudNiveauEtude