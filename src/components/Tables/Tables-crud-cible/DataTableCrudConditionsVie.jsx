...
const DataTableCrudConditionsVie = (props) => {
...
//Réception des données
    ...
    useEffect(() => {
        ...
        productService.getConditionsVie().then(data =>  setProducts(data));
        ...
        return (
            <React.Fragment>
                <div  className="d-flex" style={{justifyContent:"space-between"}} >
                    ...
                    <span className='h3'>Liste Conditions de vie</span>
...
export default DataTableCrudConditionsVie